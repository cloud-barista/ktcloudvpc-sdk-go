...
func AddUser(client *ktvpcsdk.ServiceClient, tenantID, userID, roleID string) (r UserRoleResult) {
	resp, err := client.Put(userRoleURL(client, tenantID, userID, roleID), nil, nil, &ktvpcsdk.RequestOpts{
		OkCodes: []int{200, 201},
	})
...
func DeleteUser(client *ktvpcsdk.ServiceClient, tenantID, userID, roleID string) (r UserRoleResult) {

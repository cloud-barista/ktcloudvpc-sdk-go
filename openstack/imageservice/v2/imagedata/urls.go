...
func uploadURL(c *ktvpcsdk.ServiceClient, imageID string) string {
	return c.ServiceURL(rootPath, imageID, uploadPath)
}

func stageURL(c *ktvpcsdk.ServiceClient, imageID string) string {
	return c.ServiceURL(rootPath, imageID, stagePath)
}

func downloadURL(c *ktvpcsdk.ServiceClient, imageID string) string {

...
var FirstNetwork = networks.Network{
	...
	CIDR:              "10.0.0.0/29",
	CIDRv6:            "",
	CreatedAt:         ktvpcsdk.JSONRFC3339MilliNoZ(time.Date(2011, 8, 15, 6, 19, 19, 387525000, time.UTC)),
	Deleted:           false,
	DeletedAt:         ktvpcsdk.JSONRFC3339MilliNoZ(nilTime),
	DHCPStart:         "10.0.0.3",
	DNS1:              "",
	DNS2:              "",
	Gateway:           "10.0.0.1",
	...
	ProjectID:         "1234",
	RXTXBase:          0,
	UpdatedAt:         ktvpcsdk.JSONRFC3339MilliNoZ(time.Date(2011, 8, 16, 9, 26, 13, 48257000, time.UTC)),
	VLAN:              100,
...
var SecondNetwork = networks.Network{
	...
	ProjectID:         "",
	RXTXBase:          0,
	UpdatedAt:         ktvpcsdk.JSONRFC3339MilliNoZ(nilTime),
	VLAN:              101,

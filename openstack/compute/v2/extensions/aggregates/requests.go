...
func (opts CreateOpts) ToAggregatesCreateMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "aggregate")
}
...
func Create(client *ktvpcsdk.ServiceClient, opts CreateOpts) (r CreateResult) {
	...
	resp, err := client.Post(aggregatesCreateURL(client), b, &r.Body, &ktvpcsdk.RequestOpts{
		OkCodes: []int{200},
	})
...
func Delete(client *ktvpcsdk.ServiceClient, aggregateID int) (r DeleteResult) {
	v := strconv.Itoa(aggregateID)
	resp, err := client.Delete(aggregatesDeleteURL(client, v), &ktvpcsdk.RequestOpts{
		OkCodes: []int{200},
	})
	_, r.Header, r.Err = ktvpcsdk.ParseResponse(resp, err)
	return
...
func Get(client *ktvpcsdk.ServiceClient, aggregateID int) (r GetResult) {
	v := strconv.Itoa(aggregateID)
	resp, err := client.Get(aggregatesGetURL(client, v), &r.Body, &ktvpcsdk.RequestOpts{
		OkCodes: []int{200},
	})
	_, r.Header, r.Err = ktvpcsdk.ParseResponse(resp, err)
	return
...
func Update(client *ktvpcsdk.ServiceClient, aggregateID int, opts UpdateOpts) (r UpdateResult) {
	v := strconv.Itoa(aggregateID)
	...
	resp, err := client.Put(aggregatesUpdateURL(client, v), b, &r.Body, &ktvpcsdk.RequestOpts{
		OkCodes: []int{200},
	})
	_, r.Header, r.Err = ktvpcsdk.ParseResponse(resp, err)
	return
...
func (opts AddHostOpts) ToAggregatesAddHostMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "add_host")
}

// AddHost makes a request against the API to add host to a specific aggregate.
func AddHost(client *ktvpcsdk.ServiceClient, aggregateID int, opts AddHostOpts) (r ActionResult) {
	v := strconv.Itoa(aggregateID)
	...
	resp, err := client.Post(aggregatesAddHostURL(client, v), b, &r.Body, &ktvpcsdk.RequestOpts{
		OkCodes: []int{200},
	})
	_, r.Header, r.Err = ktvpcsdk.ParseResponse(resp, err)
	return
...
func (opts RemoveHostOpts) ToAggregatesRemoveHostMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "remove_host")
}

// RemoveHost makes a request against the API to remove host from a specific aggregate.
func RemoveHost(client *ktvpcsdk.ServiceClient, aggregateID int, opts RemoveHostOpts) (r ActionResult) {
	v := strconv.Itoa(aggregateID)
	...
	resp, err := client.Post(aggregatesRemoveHostURL(client, v), b, &r.Body, &ktvpcsdk.RequestOpts{
		OkCodes: []int{200},
	})
	_, r.Header, r.Err = ktvpcsdk.ParseResponse(resp, err)
	return
...
func (opts SetMetadataOpts) ToSetMetadataMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "set_metadata")
}

// SetMetadata makes a request against the API to set metadata to a specific aggregate.
func SetMetadata(client *ktvpcsdk.ServiceClient, aggregateID int, opts SetMetadataOpts) (r ActionResult) {
	v := strconv.Itoa(aggregateID)
	...
	resp, err := client.Post(aggregatesSetMetadataURL(client, v), b, &r.Body, &ktvpcsdk.RequestOpts{
		OkCodes: []int{200},
	})
	_, r.Header, r.Err = ktvpcsdk.ParseResponse(resp, err)
	return

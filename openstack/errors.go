...
type ErrEndpointNotFound struct{ ktvpcsdk.BaseError }
...
type ErrInvalidAvailabilityProvided struct{ ktvpcsdk.ErrInvalidInput }
...
// found
type ErrNoAuthURL struct{ ktvpcsdk.ErrInvalidInput }
...
// found
type ErrNoUsername struct{ ktvpcsdk.ErrInvalidInput }
...
// found
type ErrNoPassword struct{ ktvpcsdk.ErrInvalidInput }

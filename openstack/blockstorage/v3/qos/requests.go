...
func (opts CreateOpts) ToQoSCreateMap() (map[string]interface{}, error) {
	b, err := ktvpcsdk.BuildRequestBody(opts, "qos_specs")
	if err != nil {
		return nil, err
	}
...
func Delete(client *ktvpcsdk.ServiceClient, id string, opts DeleteOptsBuilder) (r DeleteResult) {
...
func DeleteKeys(client *ktvpcsdk.ServiceClient, qosID string, opts DeleteKeysOptsBuilder) (r DeleteResult) {
	b, err := opts.ToDeleteKeysCreateMap()
	if err != nil {
		r.Err = err
		return
	}
	resp, err := client.Put(deleteKeysURL(client, qosID), b, nil, &ktvpcsdk.RequestOpts{
		OkCodes: []int{202},
	})
	_, r.Header, r.Err = ktvpcsdk.ParseResponse(resp, err)
	return
...
func Associate(client *ktvpcsdk.ServiceClient, qosID string, opts AssociateOptsBuilder) (r AssociateResult) {
...
func Disassociate(client *ktvpcsdk.ServiceClient, qosID string, opts DisassociateOptsBuilder) (r DisassociateResult) {
...
func DisassociateAll(client *ktvpcsdk.ServiceClient, qosID string) (r DisassociateAllResult) {
	resp, err := client.Get(disassociateAllURL(client, qosID), nil, &ktvpcsdk.RequestOpts{
		OkCodes: []int{202},
	})
	_, r.Header, r.Err = ktvpcsdk.ParseResponse(resp, err)
	return
...
func ListAssociations(client *ktvpcsdk.ServiceClient, qosID string) pagination.Pager {

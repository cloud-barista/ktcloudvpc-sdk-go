...
func (opts AttachOpts) ToVolumeAttachMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "os-attach")
}

// Attach will attach a volume based on the values in AttachOpts.
func Attach(client *ktvpcsdk.ServiceClient, id string, opts AttachOptsBuilder) (r AttachResult) {
...
func BeginDetaching(client *ktvpcsdk.ServiceClient, id string) (r BeginDetachingResult) {
...
func (opts DetachOpts) ToVolumeDetachMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "os-detach")
}

// Detach will detach a volume based on volume ID.
func Detach(client *ktvpcsdk.ServiceClient, id string, opts DetachOptsBuilder) (r DetachResult) {
...
func Reserve(client *ktvpcsdk.ServiceClient, id string) (r ReserveResult) {
...
func Unreserve(client *ktvpcsdk.ServiceClient, id string) (r UnreserveResult) {
...
func (opts InitializeConnectionOpts) ToVolumeInitializeConnectionMap() (map[string]interface{}, error) {
	b, err := ktvpcsdk.BuildRequestBody(opts, "connector")
...
func InitializeConnection(client *ktvpcsdk.ServiceClient, id string, opts InitializeConnectionOptsBuilder) (r InitializeConnectionResult) {
...
func TerminateConnection(client *ktvpcsdk.ServiceClient, id string, opts TerminateConnectionOptsBuilder) (r TerminateConnectionResult) {
...
func (opts ExtendSizeOpts) ToVolumeExtendSizeMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "os-extend")
}

// ExtendSize will extend the size of the volume based on the provided information.
// This operation does not return a response body.
func ExtendSize(client *ktvpcsdk.ServiceClient, id string, opts ExtendSizeOptsBuilder) (r ExtendSizeResult) {
...
func (opts UploadImageOpts) ToVolumeUploadImageMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "os-volume_upload_image")
}

// UploadImage will upload an image based on the values in UploadImageOptsBuilder.
func UploadImage(client *ktvpcsdk.ServiceClient, id string, opts UploadImageOptsBuilder) (r UploadImageResult) {
...
func (opts ImageMetadataOpts) ToImageMetadataMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "os-set_image_metadata")
}

// SetImageMetadata will set image metadata on a volume based on the values in ImageMetadataOptsBuilder.
func SetImageMetadata(client *ktvpcsdk.ServiceClient, id string, opts ImageMetadataOptsBuilder) (r SetImageMetadataResult) {
...
func (opts BootableOpts) ToBootableMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "os-set_bootable")
}

// SetBootable will set bootable status on a volume based on the values in BootableOpts
func SetBootable(client *ktvpcsdk.ServiceClient, id string, opts BootableOpts) (r SetBootableResult) {
...
func (opts ChangeTypeOpts) ToVolumeChangeTypeMap() (map[string]interface{}, error) {
	return ktvpcsdk.BuildRequestBody(opts, "os-retype")
}

// ChangeType will change the volume type of the volume based on the provided information.
// This operation does not return a response body.
func ChangeType(client *ktvpcsdk.ServiceClient, id string, opts ChangeTypeOptsBuilder) (r ChangeTypeResult) {

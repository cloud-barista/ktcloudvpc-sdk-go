...
func Get(client *ktvpcsdk.ServiceClient, datastoreID string) (r GetResult) {
...
// datastore type.
func ListVersions(client *ktvpcsdk.ServiceClient, datastoreID string) pagination.Pager {
...
func GetVersion(client *ktvpcsdk.ServiceClient, datastoreID, versionID string) (r GetVersionResult) {

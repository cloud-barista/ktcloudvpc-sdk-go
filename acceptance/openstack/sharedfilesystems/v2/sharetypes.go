...
import (
	...
	"github.com/cloud-barista/ktcloudvpc-sdk-for-drv/openstack/sharedfilesystems/v2/sharetypes"
)
...
func CreateShareType(t *testing.T, client *ktvpcsdk.ServiceClient) (*sharetypes.ShareType, error) {
	if testing.Short() {
...
func DeleteShareType(t *testing.T, client *ktvpcsdk.ServiceClient, shareType *sharetypes.ShareType) {

...
// function.
func DeleteSnapshotshot(t *testing.T, client *ktvpcsdk.ServiceClient, snapshot *snapshots.Snapshot) {
...
// function.
func DeleteVolumeType(t *testing.T, client *ktvpcsdk.ServiceClient, volumeType *volumetypes.VolumeType) {
